...
/**
 * INVENTORY TESTS
 * Stock in, stock out, low stock, validation
 */
class InventoryTest extends TestCase
{
    ...
    // ──────────────────────────────────────────────
    // TEST 29: Stock-in successfully add karna
    // ──────────────────────────────────────────────
    ...
    // ──────────────────────────────────────────────
    // TEST 30: Stock-out — sufficient stock hone pe success
    // ──────────────────────────────────────────────
    ...
    // ──────────────────────────────────────────────
    // TEST 31: Insufficient stock pe 400 error
    // ──────────────────────────────────────────────
    public function test_stock_out_fails_when_insufficient_stock(): void
    {
        ...
        $response = $this->postJson('/api/v1/owner/inventory/stock-out', [
            'product_id' => $product->id,
            'quantity'   => 10, // 3 se zyada nahi le sakte
            'reason'     => 'Overkill',
        ], $this->ownerHeaders($owner, $tenant));
    ...
    // ──────────────────────────────────────────────
    // TEST 32: Bina auth ke inventory access nahi
    // ──────────────────────────────────────────────
